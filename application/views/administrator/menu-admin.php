        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
            <a href="#"><i class="fa fa-users"></i> <span>Modul Layanan</span><i class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
            <li>
            <a href="#"><i class="fa fa-circle-o"></i>  Surat</a>
                <ul class="treeview-menu">
                  ...
                  <li><a href="<?php echo base_url('Surat/SK_tidakmampu') ?>"><i class="fa fa-envelope-o"></i>SK Tidak Mampu</a></li>
                  <li><a href="<?php echo base_url('Surat/SK_domisili') ?>"><i class="fa fa-envelope-o"></i>SK Domisili</a></li>
                  <li><a href="<?php echo base_url('Surat/SK_serba') ?>"><i class="fa fa-envelope-o"></i>SK Serba Guna</a></li>
                  <li><a href="<?php echo base_url('Surat/SK_kelahiran') ?>"><i class="fa fa-envelope-o"></i>SK Kelahiran</a></li>
                  <li><a href="<?php echo base_url('Surat/SK_kematian') ?>"><i class="fa fa-envelope-o"></i>SK Kematian</a></li>
                  <li><a href="<?php echo base_url('Surat/SK_pindah') ?>"><i class="fa fa-envelope-o"></i>SK Pindah</a></li>
                  <li><a href="<?php echo base_url('Surat/pb_kkbaru') ?>"><i class="fa fa-envelope-o"></i>Pembuatan KK Baru</a></li>
                  <li><a href="<?php echo base_url('Surat/pb_kk') ?>"><i class="fa fa-envelope-o"></i>Pembaruan KK</a></li>
                  <li><a href="<?php echo base_url('Surat/pb_ktp') ?>"><i class="fa fa-envelope-o"></i>Pembuatan KTP</a></li>
                  <li><a href="<?php echo base_url('Surat/pb_akta') ?>"><i class="fa fa-envelope-o"></i>Pembuatan Akta Lahir</a></li>
                  <li><a href="<?php echo base_url('Surat/pb_izin') ?>"><i class="fa fa-envelope-o"></i>Pembuatan Perizinan</a></li>
                  <li><a href="<?php echo base_url('Surat/pb_migrasi') ?>"><i class="fa fa-envelope-o"></i>Migrasi</a></li>
                  </ul>
              </ul>
            </li>
            </li>
