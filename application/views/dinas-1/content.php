...
<section class="section section-no-background m-none">
	<div class="container">
		...
		<h2 class="text-center">GALERI <strong>VIDEO</strong></h2>
		</div>
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 welcome padding-left-none padding-bottom-40 scroll_effect fadeInUp">
			...
			?>
			<iframe width="500" height="210" src="<?php echo str_replace('watch?v=', 'embed/',  $vid1['youtube']); ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			<?php
			}
			?>
		</div>
		...
		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 welcome padding-left-none padding-bottom-40 scroll_effect fadeInUp">
				...
				?>
				<iframe width="500" height="210" src="<?php echo str_replace('watch?v=', 'embed/',  $vid2['youtube']); ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<?php
				}
				?>
		</div>
